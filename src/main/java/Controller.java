...
public class Controller {
     ...
     */
    public Controller(PlayerBoard playerBoard, BattleshipProtocol p, Connectable c) {
        // Init Model
        ...
        if (playerBoard.getGameStatus() == GameBoard.GameStatus.INIT) {
            ...
            if (p == GameBoard.PlayerStatus.NOT_READY) {
                if (playerBoard.getUnsetShips().size() == 0){
                    ...
                    connection.send("%s".formatted(BattleshipProtocol.GameCommand.READY));
    ...
    public void concludeGame() {
        ...
        if (next) {
            ...
            connection.send("%s".formatted(BattleshipProtocol.GameCommand.RESTART));
